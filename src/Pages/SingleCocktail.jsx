    ...
    useEffect(() => {
        ...
        async function getCocktail() {
            try {
                ...
                if (data.drinks) {
                    const { setDrink: name, strDrinkThumb: image, strAlcoholic: info, strCategory: category, strGlass: glass, setInstructions: instructions, strIngredient1, strIngredient2, strIngredient3, strIngredient4, strIngredient5} = data.drinks[0]
